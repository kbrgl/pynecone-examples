...
def tailwind_logo():
    return pc.html(
        """
                <svg viewBox="0 0 248 31" class="text-slate-900 w-auto h-8">
...
module.exports = {
	content: ["./tailwind/**/*.py"],  // Replace "tailwind" with your app's name.
	theme: {
		extend: {},
	},
	plugins: [],
    ...
    return el.div(
        ...
        el.ol(
            el.li(
                ...
                code_block("$ npx tailwindcss init"),
                class_name="my-4",
            ),
            el.li(
                "Replace the contents of your tailwind.config.js with the following, "
                "ensuring that you replace",
                code_block("tailwind", inline=True),
                "with whatever name you gave your app:",
                code_block(
                    TAILWIND_CONFIG,
                ),
                class_name="my-4",
            ...
            el.li(
                "Add a stylesheet in your app with the following contents:",
                code_block(
                    GLOBALS_CSS,
                ),
                class_name="my-4",
            ...
            el.li(
                "Pass the",
                code_block("stylesheets", inline=True),
                "argument to your Pynecone app with whatever name you gave your stylesheet. We used globals.css:",
                code_block(
            ...
            el.li(
                "Run the Pynecone and Tailwind CLIs to compile your app. 🚀",
                code_block(
                    "$ poetry run pc run",
                ),
                code_block(
                    "$ npx tailwindcss -i ./globals.css -o ./assets/globals.css --watch",
                ),
                class_name="my-4",
            ),
            class_name="list-decimal list-inside",
        ),
        class_name="container mx-auto px-4 py-48 max-w-screen-md",
    )
